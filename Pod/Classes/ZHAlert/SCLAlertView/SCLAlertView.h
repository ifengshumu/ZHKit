...
/** Set button width when horizontal alignment
 *
 * equal width if YES
 */
@property (nonatomic) BOOL horizontalButtonEqualWidth;

/** Initialize SCLAlertView using windowWidth.
 *
 * Init with windowWidth
 */
