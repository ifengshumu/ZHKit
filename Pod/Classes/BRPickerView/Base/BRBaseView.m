...
- (UIView *)maskView {
    if (!_maskView) {
        _maskView = [[UIView alloc]initWithFrame:mScreenBounds];
...
- (UIView *)alertView {
    if (!_alertView) {
        ...
        _alertView = [[UIView alloc]initWithFrame:CGRectMake(0, mScreenHeight - height, mScreenWidth, height)];
...
- (UIView *)titleBarView {
    if (!_titleBarView) {
        _titleBarView =[[UIView alloc]initWithFrame:CGRectMake(0, 0, mScreenWidth, self.pickerStyle.titleBarHeight)];
