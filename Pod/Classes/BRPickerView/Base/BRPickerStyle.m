...
- (UIColor *)maskColor {
    if (!_maskColor) {
        _maskColor = [UIColor colorWithWhite:0 alpha:0.4f];
    }
    return _maskColor;
}
...
- (CGRect)titleLabelFrame {
    if (CGRectEqualToRect(_titleLabelFrame, CGRectZero) || _titleLabelFrame.size.height == 0) {
        _titleLabelFrame = CGRectMake(5 + 60 + 2, 0, mScreenWidth - 2 * (5 + 60 + 2), 44);
    }
...
- (CGRect)doneBtnFrame {
    if (CGRectEqualToRect(_doneBtnFrame, CGRectZero) || _doneBtnFrame.size.height == 0) {
        _doneBtnFrame = CGRectMake(mScreenWidth - 60 - 5, 8, 60, 28);
    }
...
+ (instancetype)pickerStyleWithDoneTextColor:(UIColor *)doneTextColor {
    ...
    if (doneTextColor) {
        ...
        customStyle.doneBtnFrame = CGRectMake(mScreenWidth - 60, 4, 60, 40);
...
+ (instancetype)pickerStyleWithDoneBtnImage:(UIImage *)doneBtnImage {
    ...
    if (doneBtnImage) {
        ...
        customStyle.doneBtnFrame = CGRectMake(mScreenWidth - 44, 4, 40, 40);
    }
    return customStyle;
}
