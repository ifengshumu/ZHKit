...
// 等比例适配系数
#ifndef kScaleFit
#define kScaleFit (BR_IS_IPHONE ? ((mScreenWidth < mScreenHeight) ? mScreenWidth / 375.0f : mScreenWidth / 667.0f) : 1.1f)
#endif
...
// 底部安全区域远离高度
#define BR_BOTTOM_MARGIN ((CGFloat)(BR_IS_iPhoneX ? ((mScreenWidth < mScreenHeight) ? 34 : 21) : 0))
