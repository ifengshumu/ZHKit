...
-(void)loadPhotoData
{
    if ([self.delegate respondsToSelector:@selector(zzbrowserPickerPhoto:)]) {
        [self.photoDataArray addObjectsFromArray:[self.delegate zzbrowserPickerPhoto:self]];
    }
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    id image = [_photoDataArray objectAtIndex:indexPath.row];
    if ([image isKindOfClass:[UIImage class]]){
        [browerCell loadPicData:image];
    }
